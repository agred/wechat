...
class Privacy extends ApiThird
{
     ...
     */
    public function set_privacy_setting($access_token, $owner_setting, $privacy_ver, $setting_list)
    {
     ...
     * @return bool|mixed|string
     */
    public function get_privacy_setting($access_token, $privacy_ver)
    {
     ...
     * @return bool|string
     */
    public function upload_privacy_ext_file($access_token, $file)
    {
     ...
     * @return bool|string
     */
    public function get_privacy_interface($access_token)
    {
     ...
     * @return bool|mixed|string
     */
    public function apply_privacy_interface($access_token, $api_name, $content, $url_list, $pic_list, $video_list)
    {
